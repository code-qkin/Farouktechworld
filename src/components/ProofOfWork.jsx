...
import { Play, Camera, Wrench, ChevronRight, X, Clock, CheckCircle, ChevronLeft } from 'lucide-react';
...
const projects = [
    {
        id: 1,
        title: 'iPhone 13 Pro Max Screen',
        category: 'screen',
        type: 'image',
        before: 'https://images.unsplash.com/photo-1605236453806-6ff36851218e?q=80&w=800&auto=format&fit=crop',
        after: 'https://images.unsplash.com/photo-1663431263230-1c95353ee39a?q=80&w=800&auto=format&fit=crop',
        desc: 'Complete OLED restoration with TrueTone programming.',
        duration: '45 Mins'
    },
    {
        id: 2,
        title: 'Samsung S23 Ultra Restoration',
        category: 'screen',
        type: 'video',
        thumbnail: 'https://images.unsplash.com/photo-1678911820864-e2c567c655d7?q=80&w=800&auto=format&fit=crop',
        videoUrl: 'https://assets.mixkit.co/videos/preview/mixkit-hands-fixing-a-smartphone-1456-large.mp4',
        desc: 'Full glass replacement preserving original LCD.',
    ...
    },
    {
        ...
        category: 'battery',
        type: 'image',
        before: 'https://images.unsplash.com/photo-1517336714731-489689fd1ca4?q=80&w=800&auto=format&fit=crop',
        after: 'https://images.unsplash.com/photo-1629131726692-1accd0c53ce0?q=80&w=800&auto=format&fit=crop',
        desc: 'Swollen battery removal and chassis cleaning.',
        duration: '2 Hours'
    },
    {
        id: 4,
        title: 'iPad Air Housing Swap',
        category: 'housing',
        type: 'image',
        before: 'https://images.unsplash.com/photo-1544244015-0df4b3ffc6b0?q=80&w=800&auto=format&fit=crop',
        after: 'https://images.unsplash.com/photo-1542751371-adc38448a05e?q=80&w=800&auto=format&fit=crop',
        desc: 'Bent frame replacement with premium OEM housing.',
        duration: '3 Hours'
    },
    {
        id: 5,
        title: 'FaceID Recovery',
        category: 'software',
        type: 'image',
        before: 'https://images.unsplash.com/photo-1556656793-0275bada8d64?q=80&w=800&auto=format&fit=crop',
        after: 'https://images.unsplash.com/photo-1592899677712-a5a2542d652d?q=80&w=800&auto=format&fit=crop',
        desc: 'Complex microsoldering to restore biometric security.',
        duration: '4 Hours'
    },
    {
        id: 6,
        ...
        category: 'water',
        type: 'video',
        thumbnail: 'https://images.unsplash.com/photo-1515569067071-ec3b51335dd0?q=80&w=800&auto=format&fit=crop',
        videoUrl: 'https://assets.mixkit.co/videos/preview/mixkit-repairing-a-mobile-phone-battery-40439-large.mp4',
        desc: 'Ultrasonic cleaning and motherboard revival.',
        duration: '2 Days'
    },
    {
        id: 7,
        ...
        category: 'housing',
        type: 'image',
        before: 'https://images.unsplash.com/photo-1603539278712-19e09d572722?q=80&w=800&auto=format&fit=crop',
        after: 'https://images.unsplash.com/photo-1616348436918-111d75ca82aa?q=80&w=800&auto=format&fit=crop',
        desc: 'Laser removal of shattered glass and replacement.',
        duration: '2 Hours'
    },
    {
        id: 8,
        ...
        category: 'charging',
        type: 'image',
        before: 'https://images.unsplash.com/photo-1618410320928-25228d811631?q=80&w=800&auto=format&fit=crop',
        after: 'https://images.unsplash.com/photo-1585503418537-88331351ad99?q=80&w=800&auto=format&fit=crop',
        desc: 'Port cleaning and microsoldering new connector.',
        duration: '30 Mins'
    }
];
            ...
            <div className="bg-white w-full max-w-5xl rounded-3xl overflow-hidden shadow-2xl relative flex flex-col md:flex-row max-h-[90vh]">
                ...
                <div className="w-full md:w-2/3 bg-black flex items-center justify-center relative group">
                    {project.type === 'video' ? (
                        ...
                        <div className="relative w-full h-full">
                            <div className="absolute top-6 left-6 z-20 bg-black/60 text-white px-4 py-2 rounded-lg font-bold text-sm backdrop-blur-md">
                                HOVER TO SEE "BEFORE"
                            </div>
                            {/* The "Before" image is underneath. We fade out the "After" image on hover. */}
                ...
                <div className="w-full md:w-1/3 bg-white p-8 overflow-y-auto">
                    ...
                    <Link 
                        to="/#contact" 
                        className="block w-full bg-slate-900 text-white text-center py-4 rounded-xl font-bold hover:bg-purple-700 transition shadow-lg hover:shadow-purple-500/20"
                    >
                        Book This Repair
                    </Link>
                </div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 flex justify-center gap-2 py-4 min-w-max">
                    {categories.map(cat => (
                        <button 
                            ...
                            className={`px-6 py-2 rounded-full text-sm font-bold transition-all uppercase tracking-wide ${
                        ...
                        {totalPages > 1 && (
                            <div className="flex justify-center items-center gap-4 mt-16">
                                <button 
                                    ...
                                    className="p-3 rounded-full border border-slate-200 bg-white hover:bg-slate-50 disabled:opacity-50 disabled:cursor-not-allowed transition shadow-sm text-slate-600"
                                >
                                    <ChevronLeft size={20} />
                                </button>
