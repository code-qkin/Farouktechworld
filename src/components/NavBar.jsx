...
import { useNavigate, useLocation, Link, NavLink } from "react-router-dom"; // Added useLocation
    ...
    <nav className="bg-purple-800 text-white shadow-md">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          {/* 3. CONDITIONAL RENDERING: Only show Nav if NOT on Admin Route */}
          {!isAdminRoute && (
            <>
              {/* Desktop Nav */}
      ...
      {/* Mobile Nav Menu - Only show if NOT admin AND menu is open */}
      {!isAdminRoute && isOpen && (
